...
class ComposeTaskTest : BuildTest() {
    ...
    fun shouldComposePackageAssemblyAndSingles() {
        buildScript("compose/assembly", { runner, projectDir ->
            ...
            assertPackageFile(assemblyPkg, "jcr_root/apps/example/common/install/kotlin-osgi-bundle-1.2.20.jar")
            ...
            assertPackageFile(commonPkg, "jcr_root/apps/example/common/install/kotlin-osgi-bundle-1.2.20.jar")
