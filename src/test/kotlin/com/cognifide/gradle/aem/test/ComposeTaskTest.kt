...
class ComposeTaskTest : AemTest() {
    ...
    fun shouldComposePackageAssemblyAndSingles() {
        buildTasks("compose/assembly","aemCompose", {
            ...
            assertPackageFile(assemblyPkg, "jcr_root/apps/example/core/install/com.company.aem.core-1.0.0-SNAPSHOT.jar")
            assertPackageFile(assemblyPkg, "jcr_root/apps/example/common/.content.xml")
            assertPackageFile(assemblyPkg, "jcr_root/apps/example/common/install/com.company.aem.common-1.0.0-SNAPSHOT.jar")
            ...
            assertPackageFile(corePkg, "jcr_root/apps/example/core/install/com.company.aem.core-1.0.0-SNAPSHOT.jar")
            ...
            assertPackageFile(commonPkg, "jcr_root/apps/example/common/install/com.company.aem.common-1.0.0-SNAPSHOT.jar")
