...
class ComposeTaskTest : AemTest() {
    ...
    fun shouldComposePackageAssemblyAndSingles() {
        buildTasks("compose/assembly","aemCompose", {
            ...
            assertPackageBundle(assemblyPkg, "jcr_root/apps/example/core/install/com.company.aem.core-1.0.0-SNAPSHOT.jar")
            assertPackageFile(assemblyPkg, "jcr_root/apps/example/common/.content.xml")
            assertPackageBundle(assemblyPkg, "jcr_root/apps/example/common/install/com.company.aem.common-1.0.0-SNAPSHOT.jar")
            ...
            assertPackageBundle(corePkg, "jcr_root/apps/example/core/install/com.company.aem.core-1.0.0-SNAPSHOT.jar")
            ...
            assertPackageBundle(commonPkg, "jcr_root/apps/example/common/install/com.company.aem.common-1.0.0-SNAPSHOT.jar")
