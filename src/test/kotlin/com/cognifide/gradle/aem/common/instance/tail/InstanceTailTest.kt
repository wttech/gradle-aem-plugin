...
class InstanceTailTest {
    ...
    fun shouldParseLogs() {
        ...
        logsList.first().apply {
            assertEquals(Log.parseTimestamp("14.01.2019 12:19:48.350", aem.instanceManager.tailer.datePattern.get()), timestamp)
        ...
        logsList.last().apply {
            assertEquals(Log.parseTimestamp("14.01.2019 12:20:43.111", aem.instanceManager.tailer.datePattern.get()), timestamp)
    ...
    fun shouldParseMultilineLogs() {
        ...
        logsList[0].apply {
            assertEquals(Log.parseTimestamp("14.01.2019 12:20:05.242", aem.instanceManager.tailer.datePattern.get()), timestamp)
        ...
        logsList[2].apply {
            assertEquals(Log.parseTimestamp("14.01.2019 12:04:58.535", aem.instanceManager.tailer.datePattern.get()), timestamp)
            assertEquals("WARN", level)
    ...
    fun shouldAggregateOverlappingLogsBetweenRequests() {
        ...
        logs.first().apply {
            assertEquals(Log.parseTimestamp("14.01.2019 12:04:54.613", aem.instanceManager.tailer.datePattern.get()), timestamp)
            assertEquals("d37f9ce5287800493de0b6ef5bb43338", checksum)
        }
        logs.last().apply {
            assertEquals(Log.parseTimestamp("14.01.2019 12:04:58.773", aem.instanceManager.tailer.datePattern.get()), timestamp)
    ...
    fun shouldSkipLogsChunkWhenThereAreNoNewLogs() {
        ...
        logs.last().apply {
            assertEquals(Log.parseTimestamp("14.01.2019 12:04:58.519", aem.instanceManager.tailer.datePattern.get()), timestamp)
