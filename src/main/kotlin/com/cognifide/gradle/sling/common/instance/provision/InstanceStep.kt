...
/**
 * Represents provision step to be performed on concrete Sling instance.
 */
class InstanceStep(val instance: Instance, val definition: Step) {

    private val logger = definition.provisioner.sling.logger
    ...
    val greedy: Boolean get() = provisioner.greedy.get() || provisioner.sling.prop.flag("instance.provision.${definition.id.get()}.greedy")
    ...
    /**
     * Update provision step metadata on Sling instance.
     *
    ...
    /**
     * Perform provision step on Sling instance.
     */
