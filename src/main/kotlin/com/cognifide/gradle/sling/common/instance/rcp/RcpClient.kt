...
class RcpClient(private val sling: SlingExtension) {
    ...
    fun copy() {
        if (paths == null && pathsFile == null) {
            throw SlingException("RCP need to have defined 'rcp.paths' or 'rcp.pathsFile'!")
        }
    ...
    fun copy(sourcePath: String, targetPath: String) {
        ...
        sling.vlt("rcp $opts ${sourceInstance!!.httpBasicAuthUrl}/$workspace/-/jcr:root$sourcePath " +
