...
class CheckRunner(internal val sling: SlingExtension) {

    internal val logger = sling.logger
     ...
     */
    val delay = sling.obj.long { convention(0L) }

    /**
     * Controls if aborted running should fail build.
     */
    val verbose = sling.obj.boolean { convention(true) }
     ...
     */
    val logInstantly = sling.obj.boolean { convention(logger.isInfoEnabled) }
