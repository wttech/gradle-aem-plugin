...
```shell
curl -OJL https://github.com/Cognifide/gradle-aem-plugin/releases/download/14.6.4/gap.jar && java -jar gap.jar && rm gap.jar
```
...
```bash
curl -OJL https://github.com/Cognifide/gradle-aem-plugin/releases/download/14.6.4/gap.jar \
