...
```shell
curl -OJL https://github.com/Cognifide/gradle-aem-plugin/releases/download/15.0.3/gap.jar && java -jar gap.jar && rm gap.jar
```
...
```bash
curl -OJL https://github.com/Cognifide/gradle-aem-plugin/releases/download/15.0.3/gap.jar \
