...
Most effective way to experience Gradle AEM Plugin is to use *Quickstart* located in:
  ...
  * [AEM Boot](https://github.com/Cognifide/gradle-aem-boot) - only booting local AEM instances and AEM dispatcher automatically. Useful when building CRX packages is covered by Maven & [Content Package Maven Plugin](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/vlt-mavenplugin.html)).
